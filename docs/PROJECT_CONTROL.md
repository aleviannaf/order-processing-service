...
- [ ] Configuração do TypeORM + migrations
- [ ] Estrutura de pastas modular
- [ ] Testes rodando
- [ ] README: como rodar o projeto
**Concluída quando:** `docker compose up` sobe tudo e `npm test` funciona

---

### Sprint 1 — Domínio de Pedido
**Objetivo:** Regras de negócio claras e testadas
- [ ] Entidade Order + enum de status
- [ ] Máquina de estados
...
- [ ] Persistência `checkoutSessionId`
...
- [ ] Tabela `processed_events` (idempotência de evento)
...
- [ ] Fila (definir: Redis/BullMQ ou SQS)
...
- Última tarefa concluída: Repo criado (MIT + gitignore)
- Próxima tarefa: Adicionar README + iniciar GitFlow (`develop`)
